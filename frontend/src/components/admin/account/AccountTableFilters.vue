<template>
  <div class="flex flex-wrap items-center gap-3">
    ...
    <Select :model-value="filters.status_code" class="w-40" :options="statusCodeOpts" @update:model-value="updateStatusCode" @change="$emit('change')" />
...
const updateStatusCode = (value: string | number | boolean | null) => { emit('update:filters', { ...props.filters, status_code: value }) }
...
const statusCodeOpts = computed(() => [
  { value: '', label: t('admin.accounts.allStatusCodes') },
  { value: '400', label: '400' },
  { value: '401', label: '401' },
  { value: '402', label: '402' },
  { value: '403', label: '403' },
